...
# Create dummy user
user1 = User(name="Mahmoud Magdy", email="mm580814@gmail.com",
             picture='https://lh3.googleusercontent.com/l8gRDe4DQg_qTXeDnN_zzl1FW44X6_ra2WnNU2xJ_VJFipWIAn5KJuRK-KSw5yusqoZaWlwmlexL=w668-h670-rw-no')
session.add(user1)
session.commit()
